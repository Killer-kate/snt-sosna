...
<?php
    ...
    <main>
        ...
        <div style="text-align:center; width: 100%; border: 2px solid #A3AE36; margin-top: 1rem; border-radius: 30px; background-color: #A3AE36;">
            ...
            <table style="width: 100%;text-align:center;"><tr><td id="logo_form" align="center" style="width:30%"><img style="text-align:center;width:80%;" src="../image/logo_footer.png" alt="альтернативный текст" /></td>
                <td>
