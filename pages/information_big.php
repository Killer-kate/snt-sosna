        ...
        <div class="block__information__list">
            <div class="container">
                ...
                <div class="table__info__bus">
                    ...
                    <div class="header__bus">
                        <h3 class="header__table header__table1">Маршрут</h3>
                    ...
                    <div class="background__bus">
                        <p>55 Шатура - Дорофеево</p>
                        <p>6:05</p>
                        <p>6:24</p>
                    </div>

                    <div class="background__bus">
                        <p>54 Шатура - Орехово-Зуево</p>
                        <p>6:05</p>
                        <p>6:24</p>
                    </div>
                ...
                <div class="table__info__bus">
                    ...
                    <div class="background__bus">
                        <p>55 Дорофеево — Шатура</p>
                        <p>7:05</p>
                        <p>7:25</p>
                    </div>

                    <div class="background__bus">
                        <p>54 Орехово-Зуево — Шатура</p>
                        <p>9:05</p>
                        <p>9:25</p>
                    </div>
            ...
            <div id="info__block3" class="d_none">
                ...
                <div class="point forum__point">
                    ...
                    <h3 id="but5" class="point__h3">Отчёты, протоколы, письма</h3>
                </div>
