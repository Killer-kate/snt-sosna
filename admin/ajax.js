...
http.open('post', 'smart_php_poll/fetch.php?action=showpoll&id='+pid);
...
http.open('post', 'smart_php_poll/fetch.php?action=post_result&id='+pid+'&option='+op);
http.onreadystatechange = handleResponse;
http.send(null);
}
...
function result(pid){
http.open('post', 'smart_php_poll/fetch.php?action=see_result&id='+pid);
http.onreadystatechange = handleResponse;
http.send(null);
}
