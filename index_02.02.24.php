...
<header>
        <div class="header">
            <div class="container">
                <nav class="menu__nav">
                    <input style="margin: 10px;" type='checkbox' name="responsive-menu" id='responsive-menu' onclick='updatemenu()'>
                    <label for="responsive-menu" style="font-size: 30px; font-weight: 700;">&nbsp;&nbsp;&nbsp;"Сосна"</label>
                    <?php
                        ...
                        <li><a class='nav__link $by' href='pages/by.php'>Покупка</a></li>
                    </ul>";
                    ?>
                </nav>
            </div>
    ...
    <div class="intro">
        <div class="container">
            <div class="intro__inner">
                <h1 class="intro__title visually-hidden">Сайт садового некоммерческого товарищества СОСНА</h1>
                <h4 class="intro__title visually-hidden">Наш сайт садового некоммерческого товарищества</h4>
                <img src="image/intro__.webp" alt="сайт садового некоммерческого товарищества" style="width:100%;">
            </div>
        </div>
    </div>
    <!-- TODO INTRO end -->
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="info">
                    ...
                    <div class="block__1">
                        ...
                        <img class="info_foto2" src="image/foto2.png" alt="фото с мероприятия"></div>
                    </div>
                    <div class="block__2">
        ...
        <!-- Define each of the slides
         and write the content -->
            ...
            <div class="slide">
                <img src="image/gal/events1.png" alt="" style="margin-left:10px;margin-right: 10px;border-radius:20px;padding-bottom:7px;">
            </div>
            <div class="slide">
               <img src="image/gal/foto5.jpg" alt="" style="margin-left:10px;margin-right: 10px;border-radius:20px;padding-bottom:7px;">
            </div>
            <div class="slide">
                <img src="image/gal/gal2.png" alt="" style="margin-left:10px;margin-right: 10px;border-radius:20px;padding-bottom:7px;">
            </div>
            <div class="slide">
                <img src="image/gal/gal3.png" alt="" style="margin-left:10px;margin-right: 10px;border-radius:20px;padding-bottom:7px;">
            </div>
        </div>
    </div>
            <div id="slideshow" style="display:inline-block;">
        ...
        <!-- Define each of the slides
         and write the content -->
            ...
            <div class="slide">
                <img src="image/gal/gal5.png" alt="" style="margin-left:10px;margin-right: 10px;border-radius:20px;padding-bottom:7px;">
            </div>
        </div>
    </div>
