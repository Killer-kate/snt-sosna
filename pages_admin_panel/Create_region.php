...
<body>
    ...
    <main>
        ...
        <form class="form_contact_new">
            <span>Заголовок участка:</span>
            <input class="form_input" type="text" placeholder="Введите заголовок для участка" required>
            <span>Описание участка:</span>
            <textarea placeholder="Небольшое описание участка" required></textarea>
            <span>Удобства:</span>
            <input class="form_input" type="text" placeholder="Введите что есть на участке" required>
            <div class="conveniences_list">
                <div>
                    <span>Вода:</span>
                        <input type="text" placeholder="Скважина" required>
                </div>
                <div>
                    <span>Электричество:</span>
                        <input type="text" placeholder="есть/нет" required>
                </div>
                <div>
                    <span>Сотки:</span>
                        <input type="text" placeholder="8" required>
                </div>
            </div>
            <span>Ссылка на авито:</span>
            <input class="form_input" type="text" placeholder="Введите ссылку" required>
            <span>Добавить фото участка:</span>
            ...
            <label id="file-label">
                ...
                <button class="form_button events__button">Создать обыявление</button>
