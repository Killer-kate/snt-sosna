...
<body>
    ...
    <form class="form_contact_new">
        ...
        <span>Текст новости:</span>
            <textarea placeholder="Новости в СНТ СОСНА" required></textarea>
            <span>Добавить фото новости:</span>
    ...
    <img class="file_load_img" src="../image/icons/plus.png" alt="Нажмите для выбора файла.">
        <button class="form_button events__button">Создать новость</button>
